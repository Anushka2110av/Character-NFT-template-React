    ...
    <div className="home-container">
      ...
      <header data-thq="thq-navbar" className="home-navbar">
        ...
        >
          ...
          >
            ...
            <Link to="/blog-page" className="home-navlink2 button-clean button">
              Blog
            </Link>
          </nav>
        </div>
        <div data-thq="thq-navbar-btn-group" className="home-btn-group">
          ...
          <Link to="/subscription-page" className="home-view button">
            Subscription
          </Link>
        </div>
      ...
      <section className="home-hero">
        ...
        <div className="home-buttons">
          <button className="button">Recycle Pads Now</button>
        </div>
      </section>
          ...
          <div className="home-card">
            ...
            <div className="home-main">
              ...
              <button className="home-learn button">
                <Link to="/blog-page" className="home-navlink3">
                  Learn more
                </Link>
                <img
                  alt="image"
          ...
          <div className="home-card1">
            ...
            <div className="home-main1">
              ...
              <button className="home-learn1 button">
                <Link to="/blog-page" className="home-navlink4">
                  Learn more
                </Link>
                <img
                  alt="image"
            ...
            <div className="home-main2">
              <div className="home-content3">
                <h2 className="home-header3">
                  <span className="home-text09">Your Daily Insights-</span>
                  <br></br>
              ...
              <button className="home-learn2 button">
                <Link to="/cycle-tracking" className="home-navlink5">
                  Learn more
                </Link>
                <img
                  alt="image"
